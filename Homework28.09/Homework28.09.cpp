...
void move_window();// двигает окно консоли
void disable_cursor();// убирает курсор
void set_size_window();
void set_text();
...
void set_size_window()
{
	system("mode con cols = 130 lines = 50"); // размер окна - 130х50 символов
}
void set_text()
{
